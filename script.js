...
function collectFirstDigitalForm() {
  ...
  // This is the clean text copied by the "Copy Webex Space Message" button.
  // Per request, it does NOT include:
  // - Checklist
  // - Numbers / DIDs / Toll-Free Numbers
  // - Additional Notes
  values.copyMarkdown = coreFields.join("\n");

  // This is the full text submitted to the configured Webex Space endpoint.
  values.markdown = [
    ...coreFields,
    "",
    "**Numbers / DIDs / Toll-Free Numbers**",
