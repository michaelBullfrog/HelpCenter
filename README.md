...
## FirstDigital copy button update

The **Copy Webex Space Message** button now copies only the core submission details.
...
The configured Webex Space submit endpoint still receives the full form payload unless further customized.
