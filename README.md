...
This version replaces `script.js` with a clean, syntax-safe version.

Fixes:
- Tab clicking
- Global search
- Theme toggle
- FirstDigital copy button
- FirstDigital Webex Space submission button

If tabs stop working, check the browser console for JavaScript syntax errors.


## Webex Space message cleaned

The **Send to Webex Space** button now sends only the core FirstDigital submission fields.
...
The copy button and send button now use the same clean message format.
